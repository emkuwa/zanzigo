...
import { LayoutDashboard, ClipboardList, Route, Wallet, User, LogOut, ChevronLeft, Menu } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/driver/trips', icon: Route, label: 'My Trips' },
      ...
      <aside className={cn(
        ...
        <div className={cn('p-4 border-b border-slate-200 dark:border-slate-800', collapsed && 'lg:p-3')}>
          <div className={cn('flex items-center gap-3', collapsed && 'lg:justify-center')}>
            ...
            {!collapsed && (
              <div>
                <p className="text-sm font-bold text-slate-900 dark:text-white">Driver Panel</p>
